...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20201202/41ea740b7a894a6294fe114ae9970880.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper h1 {
		...
		border-style: solid;
		border-color: rgba(0,0,0,.3);
		background-color: rgba(31, 147, 255, 0.73);
		box-shadow: none;
		text-align: center;
	}
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">培养师号</label> 
							<input  name="peiyangshihao" placeholder="培养师号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">培养师名</label> 
							<input  name="peiyangshiming" placeholder="培养师名" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "peiyangshi/register";
				$.ajax({ 
					type: "POST",
					url: url,
